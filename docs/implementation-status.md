...
| 3a — Van der Waals / Casimir pressure | Implemented: Chapter 3 polarization and correlated-dipole illustrations, extracted source figures, adjustable plate gap/area, example mode curves, ideal pressure/force/energy, logarithmic plot and CSV sweep. See [model and sources](van-der-waals-model.md). Full 3D controls and a microscopic zepton boundary law remain in the [experiment plan](planned-experiments/casimir-effect.md). |
