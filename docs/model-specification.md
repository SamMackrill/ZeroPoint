...
[Light through the zero-point field](light-model.md) is now a separate illustrative experiment at stage 4a, using prescribed induction of successive counter-rotating pairs at fixed centres. Its half-wavelength/half-turn timing is specified independently of this medium MVP. Switching experiments preserves each laboratory’s paused state. No photon coupling or force law is added to this medium model.
